...
import com.evanadwyer.analytics.presentation.components.AnalyticsCard
        ...
        if (state == null) {
            ...
            Column(
                ...
                Row(
                    ...
                    AnalyticsCard(
                        title = stringResource(id = R.string.total_distance_ran),
                        value = state.totalDistanceRan,
                        modifier = Modifier.weight(1f)
                    )
                    Spacer(modifier = Modifier.width(16.dp))
                    AnalyticsCard(
                        title = stringResource(id = R.string.total_time_ran),
                        value = state.totalTimeRan,
                        modifier = Modifier.weight(1f)
                    )
                }
                Row(
                    ...
                    AnalyticsCard(
                        title = stringResource(id = R.string.fastest_ever_ran),
...
private fun AnalyticsDashboardStateScreenPreview() {
    RuniqueTheme {
        AnalyticsDashboardStateScreen(
            state = AnalyticsDashboardState(
                totalDistanceRan = "0.2 km",
                totalTimeRan = " 0d 0h 0m",
